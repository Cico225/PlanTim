...
<body>
    ...
    <p>2. {{ $employeeLine }} (Radnik).</p>

    <div class="clause"><strong>Član 1.</strong> Ovim ugovorom Poslodavac i Radnik uređuju međusobna prava i obaveze iz radnog odnosa, u skladu sa Zakonom o radu Brčko distrikta BiH, Pravilnikom o radu i drugim aktima poslodavca.</div>
    ...
    <div class="clause"><strong>Član 5.</strong> Plata prije oporezivanja iznosi {{ $v['salary_gross'] ?? '' }} KM.{{ $netExtra }} Osnovna plaća radnika se uvećava za zakonom propisane dodatke na plaću a prema Pravilniku o radu. Plata se može uvećati ili umanjiti za 30% u zavisnosti od rezultata rada, a ne može biti manja od minimalne zakonom predviđene plaće. Plata će se isplaćivati najkasnije do kraja tekućeg mjeseca za prethodni mjesec.</div>

    <div class="clause"><strong>Član 6.</strong> Radnik ima pravo na naknadu plaće za vrijeme korištenja godišnjeg odmora i privremene nesposobnosti za rad („bolovanje“). Radniku će se isplatiti naknada za ishranu u toku rada („topli obrok“) u skladu sa Zakonom i općim aktom Poslodavca.</div>
    ...
    <div class="clause"><strong>Član 9.</strong> Radnik ima pravo na dnevni i sedmični odmor u skladu sa Zakonom i općim aktom Poslodavca. Radnik koji radi sa punim radnim vremenom ima pravo na odmor u toku radnog dana u trajanju od 30 minuta. Ovo vrijeme se ne uračunava u radno vrijeme.</div>

    <div class="clause"><strong>Član 10.</strong> Pravo na odmore, odsustva, zaštitu na radu, zaštitu prava iz radnog odnosa i sva druga prava i obaveze po osnovu rada, koja nisu posebno uređena ovim ugovorom, ostvaruju se u skladu sa Zakonom o radu Brčko distrikta BiH, Pravilnikom o radu i drugim aktima poslodavca.</div>

    <div class="clause"><strong>Član 11.</strong> Ugovorne strane zadržavaju pravo izmjene ovog ugovora na način utvrđen Zakonom o radu i Pravilnikom o radu.</div>
    ...
    <div class="clause"><strong>Član 13.</strong> Svi drugi uslovi i odnosi koji nisu uređeni ovim ugovorom ostvaruju se u skladu sa Zakonom o radu, Pravilnikom o radu i drugim aktima poslodavca.</div>

    <div class="clause"><strong>Član 14.</strong> Sve eventualne sporove iz ovog ugovora ugovorne strane će rješavati sporazumno, a ukoliko to nije moguće, spor će se rješavati pred nadležnim sudom.</div>
