import { Check, AlertCircle, TrendingUp, Award, Gift, BookOpen, Users, Calendar } from 'lucide-react';
...
const benefitsData: CategoryBenefits[] = [
  {
    ...
    benefits: [
      ...
      { text: 'Pristup edukacijama i treninzima', icon: BookOpen },
    ],
  },
  {
    category: 'B',
    ...
    benefits: [
      ...
      { text: 'Plan poboljšanja učinka', icon: TrendingUp },
      { text: 'Pristup edukacijama i treninzima', icon: BookOpen },
      { text: 'Kolekcije i ankete', icon: Award },
    ],
  },
  {
    category: 'A',
    ...
    benefits: [
      ...
      { text: 'Uposlenički popust (4 para po sezoni)', icon: Gift },
      { text: 'Petodnevna radna sedmica mjesečno', icon: Calendar },
      { text: 'Poklon vaucher', icon: Gift },
      { text: 'Mogućnost učešća u edukacijama kao mentor', icon: Users },
    ],
  },
];
...
export default function ManagerBenefits() {
  return (
    <div id="manager-benefits" className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
                ...
                <div className="space-y-2 sm:space-y-3">
                  {category.benefits.map((benefit, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="flex items-start gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-lg bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
                      >
