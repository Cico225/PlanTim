...
{
    protected $signature = 'modules:sync {--planika-only : Sync only Planika submodule registry entries}';
    ...
    public function handle(): int
    {
        ...
        $this->info("Synced base modules and {$planikaCount} Planika submodule(s).");
